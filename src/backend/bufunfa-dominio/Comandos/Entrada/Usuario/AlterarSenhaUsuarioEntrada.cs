...
namespace JNogueira.Bufunfa.Dominio.Comandos
{
    public class AlterarSenhaUsuarioEntrada : Notificavel
    {
        ...
        public AlterarSenhaUsuarioEntrada(string email, string senhaAtual, string senhaNova, string confirmacaoSenhaNova)
        {
            ...
            this.NotificarSeNuloOuVazio(Email, "O e-mail é obrigatório e não foi informado.")
                ...
                .NotificarSeVerdadeiro(!string.IsNullOrEmpty(this.SenhaNova) && !string.IsNullOrEmpty(this.ConfirmacaoSenhaNova) && this.SenhaNova != this.ConfirmacaoSenhaNova, "A senha e a confirmação da senha são diferentes. Verifique as senhas informadas.");
